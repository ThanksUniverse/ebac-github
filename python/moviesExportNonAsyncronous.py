    ...
    if movie_soup is not None:
        ...
        if page_section is not None:
            ...
            if len(divs) > 1:
                ...
                with open('moviesNonAsynchronous.csv', mode='a', newline='', encoding='utf-8') as file:
...
def extract_movies(soup):
    ...
    # Processar cada link de filme sequencialmente (sem multithreading)
...
def main():
    ...
    end_time = time.time()
    print('Total time taken non asynchronous: ', end_time - start_time)
